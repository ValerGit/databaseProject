...
@app.route(base_path + 'user/unfollow/', methods=['POST'])
def user_unfollow():
    conn = mysql.get_db()
    cursor = conn.cursor()
    try:
...
@app.route(base_path + 'user/updateProfile/', methods=['POST'])
def user_update():
    conn = mysql.get_db()
    cursor = conn.cursor()
    try:
...
@app.route(base_path + 'user/details/', methods=['GET'])
def user_details():
    conn = mysql.get_db()
    cursor = conn.cursor()
    try:
...
@app.route(base_path + 'user/listFollowers/', methods=['GET'])
...
@app.route(base_path + 'user/listFollowing/', methods=['GET'])
